...
foreach ($comics as $comic_name) {
  $cols = new Comic();

  $cols->title = $comic_name['title'];
  $cols->description = $comic_name['description'];
  $cols->thumb = $comic_name['thumb'];
  $cols->price = $comic_name['price'];
  $cols->series = $comic_name['series'];
  $cols->sale_date = $comic_name['sale_date'];
  $cols->type = $comic_name['type'];
